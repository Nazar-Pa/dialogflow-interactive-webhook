...
const androidIntent = (agent) => {
    ...
    const params = { "template": "button", "buttonItems": [{ "uiText": "Action_1", "actionText": "action 1 selected", "isPositive": true }, { "uiText": "Action 2", "actionText": "action 2 selected", "isPositive": false }], "align": "h", "size": "l", "eventToCall": "android_event" };
